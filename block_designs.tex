...
Konfigurácie $(v_3)$ voláme symetrické $v_3$-konfigurácie. Symetrická $v_3$-konfigurácia je $S_p(v, 3, 2)$\footnote{priamo z definícii, bloky interpretujeme ako priamky}.
...
\begin{theorem}{Konfigurácia Möbius-Kantor}\\
...
\begin{figure}
	\centering
	\includegraphics[width=0.4\textwidth]{cremona_richmond_configuration}
	\caption{Konfigurácia Cremona-Richmond (zdroj obrázku: Wikipedia)}
...
\begin{itemize}
	\item Grupe $M_{11}$ zodpovedá grupe automorfizmov $S(4,5,11)$, píšeme $Aut(S(4,5,11))$ 	
