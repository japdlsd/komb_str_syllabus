...
\begin{exercise}
Nájdite jeden latinský štvorec, ktorý má traverzálu a jeden, ktorý nemá travezálu. 
\end{exercise}
...
\begin{corollary}
Latinský štvorec veľkosti $n$ má kolmú dvojičku, práve vtedy keď sa dá pokryť $n$ traverzálamy.
\end{corollary}
